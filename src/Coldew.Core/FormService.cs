...
namespace Coldew.Core
{
    public class FormService : IFormService
    {
        ...
        public FormInfo GetFormById(string formId)
        {
        ...
        {
            List<Form> forms = this._coldewManager.FormManager.GetForms();
            return forms.Select(x => x.Map()).ToList();
        }

        public List<FieldInfo> GetFields(string formId)
        {
            Form form = this._coldewManager.FormManager.GetFormById(formId);
            if (form != null)
            {
        ...
        public FieldInfo CreateStringField(string formId, string name, bool required, string defaultValue, int index)
        {
            Form form = this._coldewManager.FormManager.GetFormById(formId);
        ...
        public FieldInfo CreateTextField(string formId, string name, bool required, string defaultValue, int index)
        {
            Form form = this._coldewManager.FormManager.GetFormById(formId);
        ...
        public FieldInfo CreateDropdownField(string formId, string name, bool required, string defaultValue, List<string> selectList, int index)
        {
            Form form = this._coldewManager.FormManager.GetFormById(formId);
        ...
        public FieldInfo CreateRadioListField(string formId, string name, bool required, string defaultValue, List<string> selectList, int index)
        {
            Form form = this._coldewManager.FormManager.GetFormById(formId);
        ...
        public FieldInfo CreateCheckboxListField(string formId, string name, bool required, List<string> defaultValues, List<string> selectList, int index)
        {
            Form form = this._coldewManager.FormManager.GetFormById(formId);
        ...
        {
            StringField field = this._coldewManager.FormManager.GetFieldById(fieldId) as StringField;
            if (field != null)
            {
        ...
        {
            TextField field = this._coldewManager.FormManager.GetFieldById(fieldId) as TextField;
            if (field != null)
            {
                field.Modify(name, required, defaultValue, index);
            }
        ...
        {
            DropdownField field = this._coldewManager.FormManager.GetFieldById(fieldId) as DropdownField;
            if (field != null)
            {
        ...
        {
            RadioListField field = this._coldewManager.FormManager.GetFieldById(fieldId) as RadioListField;
            if (field != null)
            {
                field.Modify(name, required, defaultValue, selectList, index);
            }
        ...
        {
            CheckboxListField field = this._coldewManager.FormManager.GetFieldById(fieldId) as CheckboxListField;
            if (field != null)
            {
        ...
        {
            Field field = this._coldewManager.FormManager.GetFieldById(fieldId);
            if (field != null)
            {
                return field.Map();
            }
        ...
        public int GetFieldMaxIndex(string formId)
        {
            Form form = this._coldewManager.FormManager.GetFormById(formId);
            if (form != null)
            {
        ...
        public FieldInfo CreateDateField(string formId, string name, bool required, bool defaultValueIsToday, int index)
        {
            Form form = this._coldewManager.FormManager.GetFormById(formId);
        ...
        public FieldInfo CreateNumberField(string formId, string name, bool required, decimal? defaultValue, decimal? max, decimal? min, int precision, int index)
        {
            Form form = this._coldewManager.FormManager.GetFormById(formId);
        ...
        {
            DateField field = this._coldewManager.FormManager.GetFieldById(fieldId) as DateField;
            if(field != null)
            {
        ...
        {
            NumberField field = this._coldewManager.FormManager.GetFieldById(fieldId) as NumberField;
            if (field != null)
            {
