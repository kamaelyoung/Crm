...
namespace Crm.Core.Organization
{
    ...
    public class User
    {
        ...
        /// 修改用户信息之后
        /// </summary>
        public virtual event TEventHanlder<User, ChangeEventArgs<UserChangeInfo, UserInfo, User>> Changing;
        public virtual event TEventHanlder<User, ChangeEventArgs<UserChangeInfo, UserInfo, User>> Changed;
        public virtual event TEventHanlder<User, ChangeEventArgs<UserChangeInfo, UserInfo, User>> Logoffed;
        public virtual event TEventHanlder<User, ChangeEventArgs<UserChangeInfo, UserInfo, User>> Locked;
        public virtual event TEventHanlder<User, ChangeEventArgs<UserChangeInfo, UserInfo, User>> Activated;
        public virtual event TEventHanlder<User, ChangeEventArgs<UserChangeInfo, UserInfo, User>> PasswordReseted;
