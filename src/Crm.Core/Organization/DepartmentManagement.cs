...
namespace Crm.Core.Organization
{
    public class DepartmentManagement
    {
        ...
        public event TEventHanlder<DepartmentManagement, List<Department>> Loaded;

        /// <summary>
        /// 创建之前
        /// </summary>
        public event TEventHanlder<DepartmentManagement, CreateEventArgs<DepartmentCreateInfo, DepartmentInfo, Department>> Creating;

        /// <summary>
        /// 创建之后
        /// </summary>
        public event TEventHanlder<DepartmentManagement, CreateEventArgs<DepartmentCreateInfo, DepartmentInfo, Department>> Created;

        /// <summary>
        /// 删除之前
        /// </summary>
        public event TEventHanlder<DepartmentManagement, DeleteEventArgs<Department>> Deleting;

        /// <summary>
        /// 删除之后
        /// </summary>
        public event TEventHanlder<DepartmentManagement, DeleteEventArgs<Department>> Deleted;
