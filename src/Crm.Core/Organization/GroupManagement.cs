...
namespace Crm.Core.Organization
{
    public class GroupManagement
    {
        ...
        /// 加载
        /// </summary>
        public event TEventHanlder<GroupManagement, List<Group>> Loaded;
        /// <summary>
        /// 创建之前
        /// </summary>
        public event TEventHanlder<GroupManagement, CreateEventArgs<GroupCreateInfo, GroupInfo, Group>> Creating;

        /// <summary>
        /// 创建之后
        /// </summary>
        public event TEventHanlder<GroupManagement, CreateEventArgs<GroupCreateInfo, GroupInfo, Group>> Created;

        /// <summary>
        /// 删除之前
        /// </summary>
        public event TEventHanlder<GroupManagement, DeleteEventArgs<Group>> Deleting;

        /// <summary>
        /// 删除之后
        /// </summary>
        public event TEventHanlder<GroupManagement, DeleteEventArgs<Group>> Deleted;
