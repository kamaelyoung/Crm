...
namespace Crm.Core.Organization
{
    public class PositionManagement
    {
        ...
        public event TEventHanlder<PositionManagement, List<Position>> Loaded;

        /// <summary>
        /// 创建用户之前
        /// </summary>
        public event TEventHanlder<PositionManagement, CreateEventArgs<PositionCreateInfo, PositionInfo, Position>> Creating;

        /// <summary>
        /// 创建用户之后
        /// </summary>
        public event TEventHanlder<PositionManagement, CreateEventArgs<PositionCreateInfo, PositionInfo, Position>> Created;

        /// <summary>
        /// 删除用户之前
        /// </summary>
        public event TEventHanlder<PositionManagement, DeleteEventArgs<Position>> Deleting;

        /// <summary>
        /// 删除用户之后
        /// </summary>
        public event TEventHanlder<PositionManagement, DeleteEventArgs<Position>> Deleted;
