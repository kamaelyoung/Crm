    ...
    public class OrganizationManagement
    {
        public OrganizationManagement()
        {
            ...
            try
            {
                ...
                this.UserManager.Deleted += new TEventHanlder<UserManagement, DeleteEventArgs<User>>(UserManager_Deleted);
                this.PositionManager.Deleted += new TEventHanlder<PositionManagement, DeleteEventArgs<Position>>(PositionManager_Deleted);
                this.DepartmentManager.Deleted += new TEventHanlder<DepartmentManagement, DeleteEventArgs<Department>>(DepartmentManager_Deleted);
                this.GroupManager.Deleted += new TEventHanlder<GroupManagement, DeleteEventArgs<Group>>(GroupManager_Deleted);
            }
            catch(Exception ex)
            {
        ...
        private void InitManagers()
        {
            ...
            this.UserManager.Loading +=
                new TEventHanlder<UserManagement, List<User>>(this.UserService_OnLoading);
        }
