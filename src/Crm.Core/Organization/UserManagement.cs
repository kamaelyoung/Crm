...
namespace Crm.Core.Organization
{
    public class UserManagement 
    {
        ...
        internal event TEventHanlder<UserManagement, List<User>> Loading;

        public event TEventHanlder<UserManagement, List<User>> Loaded;

        /// <summary>
        /// 创建用户之前
        /// </summary>
        public event TEventHanlder<UserManagement, CreateEventArgs<UserCreateInfo, UserInfo, User>> Creating;

        /// <summary>
        /// 创建用户之后
        /// </summary>
        public event TEventHanlder<UserManagement, CreateEventArgs<UserCreateInfo, UserInfo, User>> Created;

        /// <summary>
        /// 删除用户之前
        /// </summary>
        public event TEventHanlder<UserManagement, DeleteEventArgs<User>> Deleting;

        /// <summary>
        /// 删除用户之后
        /// </summary>
        public event TEventHanlder<UserManagement, DeleteEventArgs<User>> Deleted;
        ...
        public virtual User Create(User operationUser, UserCreateInfo createInfo)
        {
            lock (this._updateLockObject)
            {
                ...
                user.Changed += new TEventHanlder<User, ChangeEventArgs<UserChangeInfo, UserInfo, User>>(User_Changed);
