...
namespace Crm.Core.Organization
{
    ...
    public class Group
    {
        ...
        /// 修改信息之前
        /// </summary>
        public virtual event TEventHanlder<Group, ChangeEventArgs<GroupChangeInfo, GroupInfo, Group>> Changing;

        /// <summary>
        /// 修改信息之后
        /// </summary>
        public virtual event TEventHanlder<Group, ChangeEventArgs<GroupChangeInfo, GroupInfo, Group>> Changed;

        public virtual event TEventHanlder<Group, ChangeEventArgs<GroupMemberInfo, GroupInfo, Group>> AddedMember;

        public virtual event TEventHanlder<Group, ChangeEventArgs<GroupMemberInfo, GroupInfo, Group>> RemovedMember;
