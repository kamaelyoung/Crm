...
namespace Crm.Core.Organization
{
    public class UserPositionManagement
    {
        ...
        public event TEventHanlder<UserPositionManagement, List<UserPosition>> Loaded;

        /// <summary>
        /// 创建用户职位之前
        /// </summary>
        public event TEventHanlder<UserPositionManagement, UserPositionOperationArgs> Creating;

        /// <summary>
        /// 创建用户职位之后
        /// </summary>
        public event TEventHanlder<UserPositionManagement, UserPositionOperationArgs> Created;

        /// <summary>
        /// 删除用户职位之前
        /// </summary>
        public event TEventHanlder<UserPositionManagement, UserPositionOperationArgs> Deleting;

        /// <summary>
        /// 删除用户职位之后
        /// </summary>
        public event TEventHanlder<UserPositionManagement, UserPositionOperationArgs> Deleted;
