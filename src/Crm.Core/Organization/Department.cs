...
namespace Crm.Core.Organization
{
    public class Department
    {
        ...
        /// 修改信息之前
        /// </summary>
        public virtual event TEventHanlder<Department, ChangeEventArgs<DepartmentChangeInfo, DepartmentInfo, Department>> Changing;

        /// <summary>
        /// 修改信息之后
        /// </summary>
        public virtual event TEventHanlder<Department, ChangeEventArgs<DepartmentChangeInfo, DepartmentInfo, Department>> Changed;
