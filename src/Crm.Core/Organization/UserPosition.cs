...
namespace Crm.Core.Organization
{
    public class UserPosition
    {
        ...
        /// 修改信息之前
        /// </summary>
        public virtual event TEventHanlder<UserPosition, UserPositionOperationArgs> Modifying;

        /// <summary>
        /// 修改信息之后
        /// </summary>
        public virtual event TEventHanlder<UserPosition, UserPositionOperationArgs> Modifyed;
